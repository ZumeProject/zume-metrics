[![Build Status](https://travis-ci.com/DiscipleTools/zume-metrics.svg?branch=master)](https://travis-ci.com/DiscipleTools/zume-metrics)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```zume_metrics()```
