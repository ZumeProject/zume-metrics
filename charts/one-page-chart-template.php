...
class Zume_Metrics_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-metrics-metrics'; // lowercase
    public $base_title = "Zume Metrics Metrics";
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    "title" => $this->title,
                    "Sample API Call" => __( "Sample API Call", 'zume-metrics' )
                ]
            ]
        );
    }
